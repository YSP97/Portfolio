      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        <div className="text-5xl flex flex-col gap-5 pt-[60px] max-md:text-[30px] max-lg:text-[40px]">
          ...
          >
            ...
            박윤선입니다. 사용자에게 웹을 통한 다양하고 편안한 경험을 제공하고
            싶어서 개발자로 전향하게 되었습니다. 사용자와의 소통이나 작업하는
            동료들과의 피드백을 중요시하여 다양한 사람들과 자주 소통하고
            사용자의 경험을 위한 개선을 위해 노력하고 있습니다. 다양한
            라이브러리와 API를 찾아보거나 새로운 기술을 공부하여 적용하는 것을
            좋아하여 새로운 도전을 나서고 있습니다.
          </p>
          <Contacts />
        </div>
        <img
