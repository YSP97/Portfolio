...
import { fitculatorImages } from "@/assets/Project/fitculator";

export const fitculator: Project = {
    id:'2',
    title: 'Fitculator',
    thumbnail: fitculatorImages.thumbnail,
    role: '팀장',
    teamSize: '프론트엔드 4인',
    ...
    slides: [
        {
            ...
            blocks: [
                {
                    type: 'image',
                    src: fitculatorImages.thumbnail
                },
                {
                    type: 'H2',
                    text: '기획의도'
        ...
        // 3. 아키텍쳐
        {
            id: 'slide-03',
                ...
                blocks: [
                    {
                        type: 'image',
                        src: fitculatorImages.architecture,
                        caption: '아키텍쳐'
                    },
                ]
        },
