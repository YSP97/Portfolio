                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        paragraph: {
                            ...
                            paragraph: 'React Query 캐싱 전략으로 변경된 행만 업데이트. 테이블 깜빡임 없이 자연스러운 UX 구조'
                        }
                    },
                    {
                        type: 'paragraphBox',
                        ...
                        paragraph: {
                            title: '드래그앤드롭 정렬',
                            paragraph: '행(Row) 드래그로 순서 변경. 중간값(Float) 계산으로 DB order 컬럼 업데이트 → 재정렬 없이 순서 유지'
                        }
                    },
                    {
                        type: 'flowChart',
                        ...
                        items: [
                            ...
                            { label: 'Row C 삽입', sublabel: 'order: 1.5', highlight: true, note: '(A + B) ÷ 2' },
            ...
            // 5 - 수행 업무 및 기여 - 엑셀 자동 등록 Jira 티켓 관리 페이지 1
            {
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        icon: '/',
                        paragraph: {
                            title: '엑셀 파싱 자동 테이블 생성성',
                            paragraph: 'Jira에서 추출한 엑셀 파일을 업로드하면 xlwings로 파싱, DB에 일괄 저장 후 테이블 자동 생성. 수동 입력 대비 대폭 시간 단축'
                        }
                    },
                    {
                        type: 'flowChart',
                        items: [
                            { label: '사용자', sublabel: '엑셀 업로드', caption: '프론트엔드 파일 선택' },
                            { label: 'REST API', sublabel: '파일 전송' },
                            { label: 'Python·xlwings', sublabel: '파싱', caption: 'ORM 보안 환경 작업 데이터 추출' },
                            { label: 'MySQL', sublabel: '일괄 저장', caption: '하위 단계 DB INSERT' },
                            { label: '테이블', sublabel: '자동 렌더링', caption: '수정·삭제 가능한 UI' },
                        ]
                    }
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        paragraph: {
                            ...
                            paragraph: '무한 스크롤로 뷰포트 진입 시점에 데이터 추가 로드. 초기 렌더링 비용 최소화로 빠른 페이지 응답 유지'
                        }
                    },
                    {
                        type: 'paragraphBox',
            ...
            // 7 - 수행 업무 및 기여 - 온보딩 가이드 페이지
            {
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        paragraph: '단순 타이틀과 본문 텍스트 파싱을 넘어, 링크 이동 버튼, 모달 팝업 버튼 등 다양한 인터랙티브 요소를 컴포넌트화하여 동적으로 렌더링되도록 설계'
                        }
                    },
                    {
                        type: 'paragraphBox',
                        ...
                        paragraph: '신규 입사자가 방대한 가이드 속에서 길을 잃지 않도록, 현재 위치와 이전 탐색 발자취를 직관적으로 보여주는 Breadcrumbs 네비게이션을 구현'
                        }
                    },
                    {
                        type: 'paragraphBox',
